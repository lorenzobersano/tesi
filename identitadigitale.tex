...
\begin{itemize}
  ...
  \begin{center}
    \includegraphics[width=\linewidth]{civic}
    \captionof{figure}{Diagramma di funzionamento di Civic.}
  \end{center}
  ...
  \begin{center}
    ...
    \captionof{figure}{Diagramma di funzionamento di SelfKey.}
  \end{center}
...
\begin{figure}[!ht]
    \includegraphics[width=\linewidth]{architetturacontract}
...
contract IdentityManager {
  ...
  Il metodo \texttt{get} serve per andare a recuperare dal mapping \texttt{registry}
  il valore corrispondente alla determinata chiave \texttt{registrationIdentifier} inserito dal dato
  \texttt{issuer} su un determinato \texttt{subject}.
  Il metodo \texttt{set} serve per andare a inserire o aggiornare nel mapping \texttt{registry}
  un valore corrispondente alla determinata chiave \texttt{registrationIdentifier} inserito dal dato
  \texttt{issuer} su un determinato \texttt{subject}.
...
\texttt{addDeclaration} permette ad un'identità uPort di aggiungere una attestazione
...
\texttt{getMigrant} va semplicemente a recuperare un Migrant in base alla sua
...
\texttt{createUportId} crea un'istanza di UPortClient con le informazioni passate dalla richiesta HTTP
